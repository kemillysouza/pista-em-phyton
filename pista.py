...
jeep_renegade=Veiculo("renegade", 55, 12.74,"o~MM~o")
indianapolis = Pista (500)
indianapolis.veiculos.append(fox)
indianapolis.veiculos.append(biz)
indianapolis.veiculos.append(jeep_renegade)
while True:
    ...
    print(indianapolis.veiculos[2].modelo, "andou", indianapolis.veiculos[2].odometro)'''
